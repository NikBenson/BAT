...
@Generated
public class Template_reduce_ImageTemplateNamedSizeConfig extends TemplateDeclarationBase {

  public Template_reduce_ImageTemplateNamedSizeConfig() {
    super(new MO());
  }

  public SNodeReference getTemplateNode() {
    return new SNodePointer("r:06cdd5b9-ab92-4965-9423-c07eea1d6828(ARD.Player.Model.generator.templates@generator)", "473053312753830760");
  }
  ...
  protected FragmentResult applyPart0(@NotNull final TemplateContext context) throws GenerationException {
    ...
    final SNode tnode1 = environment.createOutputNode(myConcepts[0]);
    {
      TemplateContext context1 = context.subContext();
      {
        ...
        {
          tnode2.setProperty(myProperties[0], "minWidth");
          TemplateContext context2 = context1.subContext();
          {
            Collection<SNode> tlist3 = null;
            final SNode copySrcInput3 = QueriesGenerated.sourceNodeQuery_7_0(new SourceSubstituteMacroNodeContext(context2, copySrcMacro));
            tlist3 = environment.copyNodes(TemplateUtil.singletonList(copySrcInput3), copySrcMacro, "tpl/r:06cdd5b9-ab92-4965-9423-c07eea1d6828/473053312753830793", context2);
      ...
      }
      {
        ...
        {
          tnode4.setProperty(myProperties[0], "value");
          TemplateContext context3 = context1.subContext();
          {
            Collection<SNode> tlist5 = null;
            final SNode copySrcInput5 = QueriesGenerated.sourceNodeQuery_7_1(new SourceSubstituteMacroNodeContext(context3, copySrcMacro1));
            tlist5 = environment.copyNodes(TemplateUtil.singletonList(copySrcInput5), copySrcMacro1, "tpl/r:06cdd5b9-ab92-4965-9423-c07eea1d6828/473053312753831096", context3);
  ...
  private static final SNodePointer copySrcMacro = new SNodePointer("r:06cdd5b9-ab92-4965-9423-c07eea1d6828(ARD.Player.Model.generator.templates@generator)", "473053312753830797");
  private static final SNodePointer copySrcMacro1 = new SNodePointer("r:06cdd5b9-ab92-4965-9423-c07eea1d6828(ARD.Player.Model.generator.templates@generator)", "473053312753831100");
}
