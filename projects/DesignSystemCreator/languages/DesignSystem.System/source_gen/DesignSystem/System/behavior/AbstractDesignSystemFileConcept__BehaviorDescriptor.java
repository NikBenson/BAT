...
public final class AbstractDesignSystemFileConcept__BehaviorDescriptor extends BaseBHDescriptor {
  private static final SAbstractConcept CONCEPT = MetaAdapterFactory.getConcept(0x43e160c7168c4805L, 0x904bc45c336610e7L, 0x6909f7b4c129d2bL, "DesignSystem.System.structure.AbstractDesignSystemFileConcept");
  ...
  private static final List<SMethod<?>> BH_METHODS = Arrays.<SMethod<?>>asList(getPresentation_idhEwIMiw, getScope_id52_Geb4QDV$, isNotParentOf_idqgBRHb$9ut);

  private static void ___init___(@NotNull SNode __thisNode__) {
  }

  /*package*/ static String getPresentation_idhEwIMiw(@NotNull SNode __thisNode__) {
    return (String) BaseConcept__BehaviorDescriptor.getPresentation_idhEwIMiw.invoke(SLinkOperations.getTarget(__thisNode__, LINKS.content$soeS));
  }
  /*package*/ static Scope getScope_id52_Geb4QDV$(@NotNull SNode __thisNode__, SAbstractConcept kind, SNode child) {
    if (SConceptOperations.isSubConceptOf(SNodeOperations.asSConcept(kind), CONCEPTS.DesignSystemConcept$8a)) {
      return ListScope.forNamedElements(Sequence.fromStream(SModelOperations.rootsIncludingImported(SNodeOperations.getModel(child), CONCEPTS.DesignSystemFileConcept$Yt).stream().map((it) -> SLinkOperations.getTarget(SNodeOperations.cast(it, CONCEPTS.DesignSystemFileConcept$Yt), LINKS.content$soeS)).filter(AbstractDesignSystemFileConcept__BehaviorDescriptor.isNotParentOf_idqgBRHb$9ut.invoke(__thisNode__.getConcept(), child))));
    }
  ...
  /*package*/ AbstractDesignSystemFileConcept__BehaviorDescriptor() {
  }
