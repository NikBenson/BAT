...
public class DesignSystemPropertyConcept_TransformationMenu extends TransformationMenuBase {
  private final Set<String> myLocations = SetSequence.fromSetAndArray(new HashSet<String>(), MenuLocations.RIGHT_SIDE_TRANSFORM, MenuLocations.CONTEXT_ASSISTANT);
  @Override
  ...
  public List<TransformationMenuItem> createMenuItems(@NotNull TransformationMenuContext context) {
    ...
    context.getEditorMenuTrace().setDescriptor(new EditorMenuDescriptorBase("default transformation menu for " + "DesignSystemPropertyConcept", new SNodePointer("r:1ff72d29-0f7c-4311-91e4-82b72c1e73e2(DesignSystem.System.editor)", "473053312771904521")));
    try {
  ...
  private class TMP_Action_8s0y8_a0 extends SingleItemMenuPart<TransformationMenuItem, TransformationMenuContext> {
    ...
    protected TransformationMenuItem createItem(TransformationMenuContext context) {
      ...
      context.getEditorMenuTrace().pushTraceInfo();
      try {
        context.getEditorMenuTrace().setDescriptor(new EditorMenuDescriptorBase(description, new SNodePointer("r:1ff72d29-0f7c-4311-91e4-82b72c1e73e2(DesignSystem.System.editor)", "473053312771904526")));
