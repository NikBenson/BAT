...
public class AbstractDesignSystemPrimitiveTokenConcept_TransformationMenu extends TransformationMenuBase {
  ...
  public List<TransformationMenuItem> createMenuItems(@NotNull TransformationMenuContext context) {
    ...
    context.getEditorMenuTrace().setDescriptor(new EditorMenuDescriptorBase("default transformation menu for " + "AbstractDesignSystemPrimitiveTokenConcept", new SNodePointer("r:e6a8cd78-a33d-415d-87ef-59be2a0e4fc6(DesignSystem.App.editor)", "473053312780534638")));
    try {
  ...
  private class TMP_Action_3gtueo_a0 extends SingleItemMenuPart<TransformationMenuItem, TransformationMenuContext> {
    ...
    protected TransformationMenuItem createItem(TransformationMenuContext context) {
      ...
      context.getEditorMenuTrace().pushTraceInfo();
      try {
        context.getEditorMenuTrace().setDescriptor(new EditorMenuDescriptorBase(description, new SNodePointer("r:e6a8cd78-a33d-415d-87ef-59be2a0e4fc6(DesignSystem.App.editor)", "473053312780534651")));
  ...
  private class TMP_Action_3gtueo_a1 extends SingleItemMenuPart<TransformationMenuItem, TransformationMenuContext> {
    ...
    protected TransformationMenuItem createItem(TransformationMenuContext context) {
      ...
      context.getEditorMenuTrace().pushTraceInfo();
      try {
        context.getEditorMenuTrace().setDescriptor(new EditorMenuDescriptorBase(description, new SNodePointer("r:e6a8cd78-a33d-415d-87ef-59be2a0e4fc6(DesignSystem.App.editor)", "473053312780586962")));
        item.setTraceInfo(context.getEditorMenuTrace().getTraceInfo());
      } finally {
        context.getEditorMenuTrace().popTraceInfo();
      }
