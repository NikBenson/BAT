...
\begin{wrapfigure}{rH}{0.35\textwidth}
    \begin{center}
        \includegraphics[width=0.33\textwidth]{../assets/img/diagrams/compiler_phases.mmd}
    \end{center}
...
Dazu wird mittels einer \acp{CFG}~\autocite{wikipedia-contributors-2024H} ein \textbf{Syntax--Tree} oder auch \textbf{\ac{AST}} erstellt.
...
Hier wird jedes Statement versucht zu interpretieren, um einfache Fehler unter den Tisch zu kehren. % TODO: Citation needed
...
Dazu zählt Geschwindigkeit, Dateigröße\footnote{Ist im Web wichtig, um die Netzwerklast zu minimieren.} etc. % TODO: Citation needed
...
\paragraph{Machine--Dependent--Code--Optimizer} optimieren den Code analog zu \nameref{par:machine-independent-code-optimizer}, nur spezifisch für die Zielplattform.
...
\paragraph{\acs{LALR}--Parser} sind dabei eine Untergruppe der Bottom--Up--Parser. % TODO: Citation needed
...
\subsubsection{BaseLanguage} % TODO: Citation needed
...
\subsubsection{Aufbau von \acs{MPS}}% TODO: Citation needed
...
\paragraph{Structure} (Struktur) beschreibt den \ac{AST} der Sprache.% TODO: Citation needed
...
\lstinputlisting[label={lst:concept-structure},caption={Aufbau eines Konzepts},language=mps-concept]{../assets/code/mps/structure.concept}
...
\paragraph{Editor} beschreibt die Darstellung sowie grundlegende Modifikation des \ac{AST}.% TODO: Citation needed
...
\subparagraph{Editor} hat als seine drei wichtigsten Konzepte den {\ttfamily Concept Editor}, also den Editor für ein Konzept; die {\ttfamily Editor Component}, eine wiederverwendbare Teildarstellung eines Konzepts und Stylesheets.% TODO: Citation needed
...
\subparagraph{Transformator} ist in erster Linie das {\ttfamily Transformation Menu}--Konzept.% TODO: Citation needed
...
\paragraph{Actions} beschreiben, wie Knoten sich verändern.% TODO: Citation needed
...
\paragraph{Intentions} ermöglichen es, das Context--Menü zu befüllen.% TODO: Citation needed
...
\paragraph{Plugin} ermöglichen es, der \ac{IDE} beliebige Funktionalitäten hinzuzufügen.% TODO: Citation needed
Es kann jedes Menü bearbeitet werden, \ac{UI}--Panels hinzugefügt werden, Progress--Indikatoren angezeigt werden etc.

\paragraph{Refactorings} spezialisieren sich auf eine bestimmte Art von \acs{IDE}--Feature.% TODO: Citation needed
...
\paragraph{FindUsages} erleichtern die Navigation durch den Code.% TODO: Citation needed
Sie sorgen dafür, dass {\ttfamily references} in beiden Richtungen aufgelöst werden können.

\paragraph{Scripts} lassen sich über die Menüleiste aufrufen.% TODO: Citation needed
...
\paragraph{Constraints} sind \ac{MPS} Äquivalent zu Semantic Analyzern.% TODO: Citation needed
...
\paragraph{Feedback} beschreibt, wie das Verstoßen gegen Constraints angezeigt werden soll.% TODO: Citation needed
Es werden also Fehlermeldungen aus den umgebenen Knoten zusammengetragen.

\paragraph{Typesystem} kann genutzt werden, um Sprachen ein Typsystem zu geben.% TODO: Citation needed
...
\paragraph{DataFlow} beschreibt den Kontrollfluss.% TODO: Citation needed
...
\paragraph{TextGen} ist \ac{MPS} Äquivalent zu einem klassischen Compiler.% TODO: Citation needed
...
\paragraph{Behavior} beschreibt eine Art Companion--Class zu einem Konzept.% TODO: Citation needed
...
\paragraph{Test} ermöglicht das Schreiben von Unit--Tests.% TODO: Citation needed
...
\paragraph{Migration} beschreiben, wie sich die Sprache zwischen zwei Versionen verändert hat.% TODO: Citation needed
...
\paragraph{\ac{VCS}} beschreibt, wie Merge--Konflikte behandelt werden sollen.% TODO: Citation needed
...
\subsubsection{Generator}% TODO: Citation needed
...
\paragraph{GenPlan} beschreibt die Reihenfolge, in der verschiedene Generatoren ausgeführt werden.% TODO: Citation needed
...
\paragraph{Debugging} des Generators funktioniert am einfachsten über sogenannte Transient Models.% TODO: Citation needed
...
\paragraph{Accessory Model} ist ein Model, welches mit einer Sprache assoziiert wird.% TODO: Citation needed
...
\paragraph{Runtime Module,} oder auch Library genannt, sind Module, die beschreiben, wie eine bestimmte Nicht--\acs{MPS}--Bibliothek aufgebaut ist.% TODO: Citation needed
