...
Transformatoren können komplex werden, sind es aber im Regelfall nicht.
...
\lstinputlisting[label={lst:ds-color-datatype},caption={{\ttfamily DSColor}--Datentyp},language=mps-constrained-string-datatype]{../assets/code/mps/DSColor.datatype}
Mit einem {\ttfamily Constrained Data Type} kann dies als \ac{RegEx} definiert werden.

\lstinputlisting[label={lst:ds-color-literal-concept},caption={{\ttfamily DSColorLiteral}--Konzept},language=mps-concept]{../assets/code/mps/DSColorLiteral.concept}
...
\lstinputlisting[label={lst:ds-color-literal-editor},caption={{\ttfamily DSColorLiteral}--Editor},language=mps-editor]{../assets/code/mps/DSColorLiteral.editor}
...
\lstinputlisting[label={lst:ds-color-literal-typesystem},caption={{\ttfamily DSColorLiteral}--Typesystem},language=mps-inference-rule]{../assets/code/mps/DSColorLiteral.typesystem}
...
\lstinputlisting[label={lst:ds-color-literal-generator},caption={{\ttfamily DSColorLiteral}--Generator},language=mps-template-declaration]{../assets/code/mps/DSColorLiteral.generator}
...
\lstinputlisting[label={lst:ds-color-literal-transformation-menu},caption={{\ttfamily DSColorLiteral}--Transformationsmenü},language=mps-transformation-menu]{../assets/code/mps/DSExpression.transformations}
