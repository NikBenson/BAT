...
Ich sehe \acp{DSL} als eine Möglichkeit, auch Laien die präzise Beschreibung von komplexen Systemen zu ermöglichen und die \acs{IT}--Branche zu demokratisieren.
...
\begin{itemize}
    \item Ist die nutzung von \ac{MPS} zur entwicklung von \ac{DSL} wirtschaftlich?
    \item Wie kann die Benutzerfreundlichkeit von \ac{DSL}--Entwicklungsumgebungen gesteigert werden?
    \item Wie kann die Entwicklung von \acp{DSL} in der \acs{IT}--Branche gefördert werden?
\end{itemize}
...
\begin{itemize}
    ...
    \item Handlungsempfehlungen zur Förderung der DSL-Entwicklung in der \acs{IT}--Branche.
\end{itemize}
...
Dazu zählen vor allem \ac{MPS} und der herkömmliche Compilerbau.

Anschließend wird in~\autoref{sec:vergleich-anhand-eines-einfachen-biespiels} anhand von einem einfachen Parser, der einen Fragenkatalog zu \ac{JSON} parst, \ac{MPS} mit den herkömmlichen Tools verglichen.

Zuletzt folgt in~\autoref{sec:umsetzung-eines-komplexen-beispiels} das komplexe Beispiel in \ac{MPS}: Zwei zusammengehörige Sprachen; eine um Design--Systeme zu beschreiben und eine andere, um App--Themes in diesen Systemen zu beschreiben, gefolgt von deren Auswertung anhand der Ziele aus~\autoref{subsec:zielsetzung}.
