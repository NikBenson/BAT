...
\begin{itemize}
    ...
    \item Wie kann die Entwicklung von \acp{DSL} in der IT--Branche gefördert werden?
\end{itemize}
...
\begin{itemize}
    ...
    \item Handlungsempfehlungen zur Förderung der DSL-Entwicklung in der IT--Branche.
\end{itemize}
